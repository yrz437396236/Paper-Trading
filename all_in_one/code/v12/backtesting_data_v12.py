...
def downloading(tickers,auth_token,intra_freq,year):     
    variable_name=['stock1','stock2']
    for ticker in tickers:
    ##############################################################################
        # avoid download data twice if they already exist
        if os.path.exists('data\\intra_'+ticker+'_'+year+'_'+intra_freq+'.csv'):
            break
