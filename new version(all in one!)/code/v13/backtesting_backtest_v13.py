...
def backtest(tickers,intra_freq,year,params_dict):
    ...
    # load the data
    datalist = [
    ('data\\intra_'+tickers[0]+'_'+year+'_'+intra_freq+'_filtered.csv', variable_name[0]), #[0] = Data file, [1] = Data name
    ('data\\intra_'+tickers[1]+'_'+year+'_'+intra_freq+'_filtered.csv', variable_name[1]),
    ]
    ...
    plot.savefig(tickers[0]+'_'+tickers[1]+'_Trading plot.png',dpi=1000)
...
if __name__ == "__main__":  
    ...
    intra_freq = '1min'
    year='2018'
    backtest(tickers,intra_freq,year)
